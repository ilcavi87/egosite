...
sections = dict(
    ...
    start_intro = _(u"The goal of this survey is to help you reflect on your social network, in order to better understand its composition and structure. The structure of your network can help you to do your job better and make you more effective at work. To learn about this structure, we will ask you some questions on your professional contacts, their characteristics, and their relationships."),
